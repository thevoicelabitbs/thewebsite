...
export default function SolutionSection() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-400 via-cyan-300 to-blue-500 py-24 overflow-hidden grainy-texture">
      {/* Abstract shapes */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10">
        <div className="text-center mb-20">
          <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white tracking-tight mb-8 text-shadow-3d">
            The Solution
          </h2>
          <p className="text-2xl md:text-3xl font-medium text-white/95 text-shadow-soft">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 text-shadow-3d">
              Every Monday Evening
            </h3>
            <ul className="space-y-5 text-lg md:text-xl font-medium text-white/95">
          ...
          >
            ...
            <ul className="space-y-5 text-lg md:text-xl font-semibold text-white">
              <li className="flex items-start gap-4">
                <span className="text-2xl">🎯</span>
